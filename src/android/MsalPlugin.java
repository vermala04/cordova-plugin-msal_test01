            ...
            try {
                ...
                try {
                    ...
                    data = "{\n" +
                            ...
                            "  }";
                    Log.d("MsalPlugin", "Configuration data: " + data);

                    File config = createConfigFile(data);
                    Log.d("MsalPlugin", "Config file created: " + config.getAbsolutePath());
                    ...
                    if (options.getString("accountMode").equals(SINGLE_ACCOUNT)) {
                        ...
                        Log.d("MsalPlugin", "Single account client created");
                    } else {
                        ...
                        Log.d("MsalPlugin", "Multiple account client created");
                    }
                    config.delete();
                    Log.d("MsalPlugin", "Config file deleted");
                    ...
                    Log.d("MsalPlugin", "Initialization complete");
                    MsalPlugin.this.callbackContext.success();
                } catch (JSONException ignored) {}
            } catch (InterruptedException | MsalException e) {
                Log.e("MsalPlugin", "Initialization error: " + e.getMessage());
                e.printStackTrace();
            }
        }
    });
